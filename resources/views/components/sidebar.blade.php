    ...
    <nav class="flex-1 px-4 py-6 space-y-2 overflow-y-auto">
        @if(auth()->user()->isAdmin())
            ...
            <a href="{{ route('admin.user.index') }}" 
               class="flex items-center gap-3 px-4 py-3 rounded-xl {{ request()->routeIs('admin.user.*') ? 'bg-primary text-white' : 'text-text-secondary hover:bg-background hover:text-text-primary' }} transition-all duration-200">
                <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <a href="{{ route('admin.barang.index') }}" 
               class="flex items-center gap-3 px-4 py-3 rounded-xl {{ request()->routeIs('admin.barang.*') ? 'bg-primary text-white' : 'text-text-secondary hover:bg-background hover:text-text-primary' }} transition-all duration-200">
                <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M20 7l-8-4-8 4m16 0l-8 4m8-4v10l-8 4m0-10L4 7m8 4v10M4 7v10l8 4"></path>
                </svg>
            ...
            <a href="{{ route('admin.pengajuan.index') }}" 
               class="flex items-center gap-3 px-4 py-3 rounded-xl {{ request()->routeIs('admin.pengajuan.*') ? 'bg-primary text-white' : 'text-text-secondary hover:bg-background hover:text-text-primary' }} transition-all duration-200">
                <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <a href="{{ route('admin.pengembalian.index') }}" 
               class="flex items-center gap-3 px-4 py-3 rounded-xl {{ request()->routeIs('admin.pengembalian.*') ? 'bg-primary text-white' : 'text-text-secondary hover:bg-background hover:text-text-primary' }} transition-all duration-200">
                <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        @elseif(auth()->user()->isPetugas())
            ...
            <a href="{{ route('petugas.barang.index') }}" 
               class="flex items-center gap-3 px-4 py-3 rounded-xl {{ request()->routeIs('petugas.barang.*') ? 'bg-primary text-white' : 'text-text-secondary hover:bg-background hover:text-text-primary' }} transition-all duration-200">
                <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M20 7l-8-4-8 4m16 0l-8 4m8-4v10l-8 4m0-10L4 7m8 4v10M4 7v10l8 4"></path>
                </svg>
                <span class="font-medium">Barang</span>
            ...
            <a href="{{ route('petugas.pengajuan.index') }}" 
               class="flex items-center gap-3 px-4 py-3 rounded-xl {{ request()->routeIs('petugas.pengajuan.*') ? 'bg-primary text-white' : 'text-text-secondary hover:bg-background hover:text-text-primary' }} transition-all duration-200">
                <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5H7a2 2 0 00-2 2v12a2 2 0 002 2h10a2 2 0 002-2V7a2 2 0 00-2-2h-2M9 5a2 2 0 002 2h2a2 2 0 002-2M9 5a2 2 0 012-2h2a2 2 0 012 2m-3 7h3m-3 4h3m-6-4h.01M9 16h.01"></path>
                </svg>
                <span class="font-medium">Pengajuan</span>
            ...
            <a href="{{ route('petugas.pengembalian.index') }}" 
               class="flex items-center gap-3 px-4 py-3 rounded-xl {{ request()->routeIs('petugas.pengembalian.*') ? 'bg-primary text-white' : 'text-text-secondary hover:bg-background hover:text-text-primary' }} transition-all duration-200">
                <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M16 15v-1a4 4 0 00-4-4H8m0 0l3 3m-3-3l3-3m9 14V5a2 2 0 00-2-2H6a2 2 0 00-2 2v16l4-2 4 2 4-2 4 2z"></path>
                </svg>
                <span class="font-medium">Pengembalian</span>
        ...
        @else
            ...
            <a href="{{ route('pegawai.pengajuan.index') }}" 
               class="flex items-center gap-3 px-4 py-3 rounded-xl {{ request()->routeIs('pegawai.pengajuan.*') ? 'bg-primary text-white' : 'text-text-secondary hover:bg-background hover:text-text-primary' }} transition-all duration-200">
                <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5H7a2 2 0 00-2 2v12a2 2 0 002 2h10a2 2 0 002-2V7a2 2 0 00-2-2h-2M9 5a2 2 0 002 2h2a2 2 0 002-2M9 5a2 2 0 012-2h2a2 2 0 012 2m-3 7h3m-3 4h3m-6-4h.01M9 16h.01"></path>
                </svg>

    ...
    <main class="ml-64 min-h-screen">
        ...
        <header class="h-16 bg-surface border-b border-border flex items-center justify-between px-8">
            <div class="flex items-center gap-4">
                ...
                <h2 class="text-xl font-bold text-text-primary">Edit Pengajuan</h2>
            </div>
        </header>
        ...
        <div class="p-8">
            <div class="max-w-2xl">
                <form wire:submit="save" class="bg-surface rounded-2xl border border-border p-8 space-y-6">
                    <!-- User (Pemohon) -->
                    <div>
                        <label class="block text-sm font-medium text-text-primary mb-2">Pegawai</label>
                        <select 
                            wire:model="id_user"
                    ...
                    <!-- Barang -->
                    <div>
                        <label class="block text-sm font-medium text-text-primary mb-2">Barang</label>
                        <select 
                    ...
                    <div>
                        ...
                        <p class="mt-1 text-xs text-text-secondary">
                            ⚠️ Mengubah status akan mempengaruhi stok barang.
                        </p>
                    </div>

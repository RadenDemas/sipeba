    ...
    <main class="ml-64 min-h-screen">
        ...
        <header class="h-16 bg-surface border-b border-border flex items-center justify-between px-8">
            <div class="flex items-center gap-4">
                ...
                <h2 class="text-xl font-bold text-text-primary">Tambah Barang</h2>
            </div>
        </header>
                ...
                <form wire:submit="save" class="bg-surface rounded-2xl border border-border p-8 space-y-6">
                    ...
                    <div>
                        ...
                        <textarea 
                            ...
                            class="w-full px-4 py-3 rounded-xl border border-border bg-background text-text-primary placeholder-text-secondary/50 focus:outline-none focus:ring-2 focus:ring-primary focus:border-transparent resize-none"
                        ></textarea>
                        @error('deskripsi')
                            <p class="mt-2 text-sm text-rejected">{{ $message }}</p>
                        @enderror
